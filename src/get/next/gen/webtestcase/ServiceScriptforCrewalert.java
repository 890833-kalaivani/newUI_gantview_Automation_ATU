...
public class ServiceScriptforCrewalert extends CommonTest {
...
public void T01_checkcrewalerthappeningproperly() throws Exception {
	...
	String Stations[] = {"DFW","PHL","MIA","PHX",};
	//String Stations[] = {"MIA"};
	
//	String Stations[] = {"CLT"};
	
	String strStartTime2 = "2018-04-12T00:02:49.540Z";
	String strEndTime2 = "2018-04-12T23:58:49.540Z";
	...
	public void GETNG_TC_EOBTServicevalidation() throws Exception {
		...
		//	String url_cache="http://10.245.15.40:8080/GetNGServices/flight/getFlightsForGivenTime";	
			...
			{	
				...
				String strStartTime= correction.getpasthrs("America/Chicago",2);
				String strEndTime=correction.getEndtime("America/Chicago",-30);
